bar.plt.soc.dif <- function(x, main = NULL){ # Life Expectancy across Regions
  
  pct <- data.frame(x) # Create Separate Data Frame
  ...
  legend(x = "bottom", inset = c(0, -.65), cex = .85, bty = "n", horiz = T,
...
bar.plt.soc.dif(dif.df,main="Life Expectancy Difference between Female & Male") 
